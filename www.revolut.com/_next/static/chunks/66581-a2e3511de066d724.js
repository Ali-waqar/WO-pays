    ...
    [66581], {
        75667: function(t, e, r) {
            ...
            var n = r(14141),
                ...
                h = r(25110),
                l = r(84032),
                f = (0, n.ZP)(l.x).withConfig({
                    displayName: "Widget",
                    componentId: "sc-1vzekdg-0"
                })(["", " ", " & &{background-color:", ";}", ""], h.k, (0, i.fw)(s.G.TABLE_ROW_X_BORDER_WIDTH, "1px"), (0, i.EN)(u.Il.GREY_TONE_5), o.$_);
            f.defaultProps = {
                bg: u.Il.WIDGET_BACKGROUND,
                color: u.Il.FOREGROUND,
                radius: a.w.WIDGET,
                display: "block"
            }
        },
        ...
        36876: function(t, e, r) {
            var n = r(14450),
                o = r(49381),
                i = function(t, e) {
                    var r = new n((e = e || {}).typeNumber || -1, e.errorCorrectLevel || o.H);
                    return r.addData(t), r.make(), r
                };
            i.ErrorCorrectLevel = o, t.exports = i
        },
        3655: function(t, e, r) {
            var n = r(32792);
        ...
        14450: function(t, e, r) {
            ...
            h.addData = function(t) {
                ...
                if (this.typeNumber < 1) {
                    ...
                    for (t = 1; t < 40; t++) {
                        ...
                        for (u = 0; u < this.dataList.length; u++) {
                            ...
                            r.put(a.mode, 4), r.put(a.getLength(), s.getLengthInBits(a.mode, t)), a.write(r)
                        }
                ...
                for (var r = this.errorCorrectLevel << 3 | e, n = s.getBCHTypeInfo(r), o = 0; o < 15; o++) {
                    var i = !t && 1 == (n >> o & 1);
                    ...
                    for (6 == u && u--;;) {
                        for (var a = 0; a < 2; a++)
                            if (null == this.modules[n][u - a]) {
                                var h = !1;
                                i < t.length && (h = 1 == (t[i] >>> o & 1)), s.getMask(e, n, u - a) && (h = !h), this.modules[n][u - a] = h, -1 == --o && (i++, o = 7)
                            }
            ...
            }, a.PAD0 = 236, a.PAD1 = 17, a.createData = function(t, e, r) {
                for (var n = o.getRSBlocks(t, e), u = new i, h = 0; h < r.length; h++) {
                    var l = r[h];
                    u.put(l.mode, 4), u.put(l.getLength(), s.getLengthInBits(l.mode, t)), l.write(u)
                }
                var f = 0;
                for (h = 0; h < n.length; h++) f += n[h].dataCount;
                ...
                for (; !(u.getLengthInBits() >= 8 * f) && (u.put(a.PAD0, 8), !(u.getLengthInBits() >= 8 * f));) u.put(a.PAD1, 8);
                return a.createBytes(u, n)
            }, a.createBytes = function(t, e) {
                for (var r = 0, n = 0, o = 0, i = new Array(e.length), a = new Array(e.length), h = 0; h < e.length; h++) {
                    var l = e[h].dataCount,
                        f = e[h].totalCount - l;
                    n = Math.max(n, l), o = Math.max(o, f), i[h] = new Array(l);
                    for (var g = 0; g < i[h].length; g++) i[h][g] = 255 & t.buffer[g + r];
                    r += l;
                    var c = s.getErrorCorrectPolynomial(f),
                        d = new u(i[h], c.getLength() - 1).mod(c);
                    a[h] = new Array(c.getLength() - 1);
                    for (g = 0; g < a[h].length; g++) {
                        var m = g + d.getLength() - a[h].length;
                        a[h][g] = m >= 0 ? d.get(m) : 0
                    }
                }
                var p = 0;
                for (g = 0; g < e.length; g++) p += e[g].totalCount;
                var v = new Array(p),
                    E = 0;
                for (g = 0; g < n; g++)
                    for (h = 0; h < e.length; h++) g < i[h].length && (v[E++] = i[h][g]);
                for (g = 0; g < o; g++)
                    for (h = 0; h < e.length; h++) g < a[h].length && (v[E++] = a[h][g]);
                return v
            }, t.exports = a
        },
        17611: function(t, e, r) {
            ...
            o.RS_BLOCK_TABLE = [
                ...
                for (var n = r.length / 3, i = new Array, s = 0; s < n; s++)
                    for (var u = r[3 * s + 0], a = r[3 * s + 1], h = r[3 * s + 2], l = 0; l < u; l++) i.push(new o(a, h));
                return i
